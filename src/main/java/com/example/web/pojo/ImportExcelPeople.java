...
public class ImportExcelPeople implements Serializable {
    private Integer id;
    ...
    public ImportExcelPeople(Integer id, String name, String phone, String address, Date enrolDate, String des) {
        this.id = id;
        this.name = name;
        this.phone = phone;
    ...
    public boolean equals(Object that) {
        ...
        ImportExcelPeople other = (ImportExcelPeople) that;
